...
function addNum(x:number, y:number): number {   // takes in two  numbers returns a number
    return x+ y
}

function log(message: string|number): void {   // takes in a message returns nothing
    console.log(message)
}
